...
def parse_args():
    ...
    parser.add_argument("--per_episode_max_len", type=int, default= 20, help="two layers maximum episode length")
    ...
    parser.add_argument("--batch_size", type=int, default=68, help="number of episodes to optimize at the same time")
