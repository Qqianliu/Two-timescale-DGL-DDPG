            ...
            for i in range(len(o)):
                ...
                if i < each_serve_user:
                    ...
                    if o[i] == 0:
                        ...
                        b_count[1] += b[i]
                elif i >= 2*each_serve_user and i < each_serve_user * 3:
                    if o[i] == 0:
                        pass
                    else:
                        b_count[2] += b[i]
                elif i >= 3*each_serve_user and i < each_serve_user * 4:
                    if o[i] == 0:
                        pass
                    else:
                        b_count[3] += b[i]
            ...
            for i in range(len(b)):
                if i < each_serve_user:
                    ...
                    if o[i] == 0:
                        ...
                        b_new.append(np.round(b[i] / b_count[3], 3))
                else:
                    if o[i] == 0:
                        b_new.append(0)
                    else:
                        b_new.append(np.round(b[i] / b_count[4], 3))
                ...
                if o[i]== 4:
                    f_new.append(np.round(f[i]/f_count[3],3))
                if o[i] == 5:
                    f_new.append(np.round(f[i] / f_count[4], 3))
            # print("offload:",o)
            # print("1bandwidth", b)
            # print("1frequency", f)
